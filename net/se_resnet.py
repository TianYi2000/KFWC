...
model_urls = {
    ...
    'se_resnet_101': 'http://data.lip6.fr/cadene/pretrainedmodels/se_resnet101-7e38fcc6.pth',
    'se_resnet_152': 'http://data.lip6.fr/cadene/pretrainedmodels/se_resnet152-d17c99b7.pth',
...
def senet154(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = SENet(BasicBlock, [3, 8, 36, 3], **kwargs)
    return model
...
def se_resnet_101(pretrained=False, progress=True, **kwargs):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = _seresnet('se_resnet_101', Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs)
    return model
